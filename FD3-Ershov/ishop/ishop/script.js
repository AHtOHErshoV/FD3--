const ShopTable = React.createClass({
    ...
    getDefaultProps: function () {
        return {
            ...
            productsArr: [{ fruit: 0, name: 'нет данных', price: 'нет данных', url: 'нет данных', counter: 'нет данных' }]
        }
    },
